...
\section{Education}
  \resumeSubHeadingListStart
    \resumeSubheading
      {UABC}{Ago. 2012 -- Jun 2017}
      {Bachelor of Physics}{Ensenada, B.C.}\\ \vspace{15pt}
    \resumeSubheading
      {IA-UNAM}{Ago. 2017 -- Oct 2020}
      ...
      \textbf{Thesis:} \textit{Methodology for the identification of exoplanet transit candidates in high cadence photometry data}\\ \vspace{3pt}
        In this project I worked with photometric data of exoplanet transits,
        taken at high cadence (20 frames per second) at the National
        Astronomical Observatory (OAN-SPM) in order to prepare a
        methodology for the automatic filtering and recognition of possible
        future exoplanet candidates that may be observed by the \href{http://taos2.astrosen.unam.mx/}{\underline{TAOS-2}}
        project.
